...
For the second cycle, my main goal was refinement and refactor. I updated all content on the website to be current. I removed/consolidated smaller projects that just served to clutter the projects section, and split career out into its own section. Lastly, I tweaked the responsive layout to better adjust for most screen configurations.
