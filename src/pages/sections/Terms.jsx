...
const SectionHome = () => {
  return (
    <Fragment>
      ...
      <p>
        The Curt Henrichs&lsquo; Portfolio website located at{" "}
      ...
      <p>
        ...
        <a href="https://www.termsofusegenerator.net" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        ...
        and its content are owned by Company or Company&lsquo;s suppliers. Note that these Terms and
      ...
      <p>
        ...
        click on any of the Third-Party Links & Ads, the applicable third party&lsquo;s terms and
        policies apply, including the third party&lsquo;s privacy and data gathering practices.
      </p>
      ...
      <p>
        ...
        damages, costs and attorney&lsquo;s fees incurred by us in connection with the written
      ...
      <p>
        ...
        to the Company should be sent to: -. After the Notice is received, you and the Company may
        attempt to resolve the claim or dispute informally. If you and the Company do not resolve
        the claim or dispute within thirty (30) days after the Notice is received, either party may
        begin an arbitration proceeding. The amount of any settlement offer made by any party may
        not be disclosed to the arbitrator until after the arbitrator has determined the amount of
      ...
      <p>
        ...
        Any hearing will be held in a location within 100 miles of Curt Henrichs&lsquo; residence,
        unless you reside outside of the United States, and unless the parties agree otherwise. If
        you reside outside of the U.S., the arbitrator shall give the parties reasonable notice of
        ...
        you an award that is greater than the last settlement offer that the Company made to you
        prior to the initiation of arbitration, the Company will pay you the greater of the award or
      ...
      <p>
        ...
        misappropriation of the other party&lsquo;s patent, copyright, trademark or trade secrets
      ...
      <p>
        ...
        subcontracted, delegated, or otherwise transferred by you without Company&lsquo;s prior
      ...
      <p>If you have any questions about this Terms of Use Policy, You can contact us:</p>
      <ul>
        <li>
          Email:&nbsp;
