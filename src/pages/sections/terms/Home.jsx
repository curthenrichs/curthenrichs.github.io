...
const SectionHome = () => {
  return (
    <Fragment>
      ...
      <p>The Curt Henrichs&lsquo; Portfolio website located at <a href="https://curthenrichs.github.io/">https://curthenrichs.github.io/</a> is a copyrighted work belonging to Curt Henrichs (hereby referred to as Company). Certain features of the Curt Henrichs&lsquo; Portfolio website (hereby shortened to Site) may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
      ...
      <p>Please note that, pursuant to 17 U.S.C. § 512(f), any misrepresentation of material fact in a written notification automatically subjects the complaining party to liability for any damages, costs and attorney&lsquo;s fees incurred by us in connection with the written notification and allegation of copyright infringement.</p>
...
Dispute Resolution. Please read this Arbitration Agreement carefully. It is part of your contract with Company and affects your rights. It contains procedures for MANDATORY BINDING ARBITRATION AND A CLASS ACTION WAIVER.</p>
      ...
      <p>Email: curthenrichs@gmail.com</p>
    </Fragment>
  );
};
